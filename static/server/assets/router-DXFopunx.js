...
const appCss = "/assets/styles-CwUrJXSo.css";
function Petals() {
  const petals = [
    { left: "8%", top: "12%", size: 18, rot: -20, delay: "0s", dur: "14s" },
    { left: "78%", top: "8%", size: 14, rot: 30, delay: "2s", dur: "18s" },
    { left: "22%", top: "60%", size: 22, rot: 15, delay: "1s", dur: "16s" },
    { left: "85%", top: "55%", size: 16, rot: -40, delay: "3s", dur: "20s" },
    { left: "55%", top: "88%", size: 12, rot: 60, delay: "0.5s", dur: "15s" },
    { left: "12%", top: "92%", size: 20, rot: -10, delay: "2.5s", dur: "19s" },
    { left: "65%", top: "30%", size: 10, rot: 5, delay: "4s", dur: "17s" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "aria-hidden": true, className: "pointer-events-none fixed inset-0 z-0 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
        @keyframes petal-drift {
          0%   { transform: translate(0,0) rotate(var(--r));   opacity: 0.75; }
          50%  { transform: translate(8px,18px) rotate(calc(var(--r) + 12deg)); opacity: 1; }
          100% { transform: translate(0,0) rotate(var(--r));   opacity: 0.75; }
        }
      ` }),
    petals.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "svg",
      {
        width: p.size,
        height: p.size,
        ...
        style: {
          ...
          top: p.top,
          ["--r"]: `${p.rot}deg`,
          animation: `petal-drift ${p.dur} ease-in-out ${p.delay} infinite`,
          filter: "drop-shadow(0 2px 6px oklch(0.7 0.12 8 / 0.25))"
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
            d: "M12 2 C 16 6, 18 12, 12 22 C 6 12, 8 6, 12 2 Z",
            fill: "oklch(0.88 0.08 10)",
            stroke: "oklch(0.78 0.12 8 / 0.6)",
            strokeWidth: "0.5"
          }
        )
      },
...
const Route$5 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "DriveSafe — Smarter, safer driving" },
      { name: "description", content: "Score every trip, lower your premium. Real-time CV-powered driving coach." },
      { name: "author", content: "DriveSafe" },
      { property: "og:title", content: "DriveSafe — Smarter, safer driving" },
      { property: "og:description", content: "Score every trip, lower your premium. Real-time CV-powered driving coach." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "DriveSafe — Smarter, safer driving" },
      { name: "twitter:description", content: "Score every trip, lower your premium. Real-time CV-powered driving coach." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3888c657-b080-4e37-8e2f-9cae8b14237d/id-preview-732b4878--dadd127a-79e9-4142-bee8-25c472f0d533.lovable.app-1778534283324.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3888c657-b080-4e37-8e2f-9cae8b14237d/id-preview-732b4878--dadd127a-79e9-4142-bee8-25c472f0d533.lovable.app-1778534283324.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
  ] });
}
var util;
(function(util2) {
...
ZodOptional.create;
ZodNullable.create;
const $$splitComponentImporter$4 = () => import("./summary-Bln0EZZi.js");
const searchSchema = objectType({
  score: numberType().optional(),
  sec: numberType().optional()
});
const Route$4 = createFileRoute("/summary")({
  head: () => ({
    meta: [{
      title: "DriveSafe — Trip summary"
    }]
  }),
  validateSearch: (s) => searchSchema.parse(s),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./profile-C5dy7P4Q.js");
const Route$3 = createFileRoute("/profile")({
  head: () => ({
    meta: [{
      title: "DriveSafe — Profile & insurance"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./live-CKzyppdP.js");
const Route$2 = createFileRoute("/live")({
  head: () => ({
    meta: [{
      title: "DriveSafe — Live drive"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./history-ddDuXIi2.js");
const Route$1 = createFileRoute("/history")({
  head: () => ({
    meta: [{
      title: "DriveSafe — Trip history"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DCmFZfGR.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      title: "DriveSafe — Home"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const SummaryRoute = Route$4.update({
  id: "/summary",
  path: "/summary",
...
const LiveRoute = Route$2.update({
  id: "/live",
  path: "/live",
  getParentRoute: () => Route$5
});
const HistoryRoute = Route$1.update({
  id: "/history",
  path: "/history",
  getParentRoute: () => Route$5
});
